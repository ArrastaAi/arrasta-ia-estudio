...
interface FirebaseAPIKeyManagementPanelProps {
  className?: string;
}

const FirebaseAPIKeyManagementPanel: React.FC<FirebaseAPIKeyManagementPanelProps> = ({ className }) => {
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="ex: Google Gemini API Key"
...
export default FirebaseAPIKeyManagementPanel;
